<div>
    ...
    if ($page == '' || $page == 1) {     // khi trang 1 hoặc ko có số trang thì begin = 0
        ...
        $begin = ($page * 9) - 9;   // khi số khác thì lấy số trang nhân với 2 và trừ đi 2 sản phẩn trang trước vd đang lấy là mỗi trang 2 sp
    }

    //$sql_pro = "SELECT * FROM tbl_sanpham  DESC LIMIT $begin,2";
    $sql_pro = "SELECT * FROM tbl_sanpham ORDER BY id_sanpham DESC LIMIT $begin,12"; //lấy tất cả sản phẩm dựa vào id 
    ...
    <div class="content-paging">
        ...
        $trang = ceil($row_count / 9); //chia cho 2 này là lấy ví dụ mỗi trang có 2 sản phẩm
        // echo $trang;
        ?>
